      ...
      <div className='bg-white w-[60%] rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6'>
        <div>
          ...
          <div className='flex flex-col gap-3 pb-10'>
            <label htmlFor="caption-input" className='text-md font-medium'>Caption</label>
            <input type="text" id="caption-input" value={caption} onChange={(event) => setCaption(event.target.value)} className='rounded outline-none text-md border-2 border-gray-200 p-2' />
            <label htmlFor="category-input">Choose a Category</label>
            <select className='outline-none border-2 border-gray-200 text-md capitalize lg:p-4 p-2 rounded cursor-pointer' onChange={(event) => setCategory(event.target.value)} id="category-input">
              {topics.map(topic => (
